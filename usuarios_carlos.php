...
$json = file_get_contents("http://192.168.0.108/trabalhows/servidor_json_bd.php");	// Check in your php.ini so allow_url_fopen is set to on.
...
if (count($obj)>0)
{
	...
	while ($i<count($obj))
	{
        ...
        $SQL = "Insert into usuario (nome,email) values ('".$obj[$i]->nome."','".$obj[$i]->email."')";
