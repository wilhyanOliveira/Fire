...
$json = file_get_contents("http://192.168.0.107/wshospital/src/controllers/clientsController.php");	// Check in your php.ini so allow_url_fopen is set to on.
...
if (count($obj)>0)
{
	...
	while ($i<count($obj))
	{
        ...
        $SQL = "Insert into clientes(nome,municipio,rua) values ('".$obj[$i]->nome."','".$obj[$i]->cidade."','".$obj[$i]->endereco."')";
