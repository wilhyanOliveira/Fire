...
$json = file_get_contents("192.168.0.101/ws_fire/cliente.php");	// Check in your php.ini so allow_url_fopen is set to on.
...
if (count($obj)>0)
{
	...
	while ($i<count($obj))
	{
        ...
        $SQL = "Insert into clientes (nome,cpf,rg,email,telefone) values ('$obj[$i]->nome','$obj[$i]->cpf','$obj[$i]->ie','$obj[$i]->telefone','obj[$i]->email')";
