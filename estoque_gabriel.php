...
$json = file_get_contents("http://192.168.0.107/wshospital/src/controllers/productsController.php");	// Check in your php.ini so allow_url_fopen is set to on.
...
if (count($obj)>0)
{
	...
	while ($i<count($obj))
	{
        ...
        $SQL = "Insert into estoque (nome,referencia,valor_venda) values ('".$obj[$i]->nome."','".$obj[$i]->descricao."','".$obj[$i]->$preco."')";
